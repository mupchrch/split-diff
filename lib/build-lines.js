...
module.exports = class DiffViewEditor {
   ...
   *
   * @param addedLines An array of buffer line numbers that should be highlighted
   *    as added.
   * @param removedLines An array of buffer line numbers that should be
  ...
  /**
   * Highlights characters in a given line. The CharDiff object is an array of
   ...
   *    value: string
   *
   * @param lineNumber The line number to highlight characters on.
   * @param parseForAddedChars An array to be parsed for any characters to
   *    highlight as added.
   * @param parseForRemovedChars An array to be parsed for any characters to
   *    highlight as removed.
   */
